    ...
    <span className="relative inline-flex items-baseline">
      ...
      {open && (
        <>
          ...
          <span className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 z-50 w-56 p-3 rounded-xl bg-anthracite-900 text-cream text-xs leading-relaxed shadow-card-hover animate-fade-in block">
